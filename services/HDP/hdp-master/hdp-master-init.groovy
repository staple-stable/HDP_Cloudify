 ...
 *******************************************************************************/
 ...
 println "hdp-master-init.groovy: Setting ipAddress to ${context.getPrivateAddress()}"
 context.attributes.thisInstance.ipAddress = context.getPrivateAddress()
 
 println "hdp-master-init.groovy: Saving the publicIp ${context.getPublicAddress()}"
 ...
 println "hdp-master-init.groovy: Setting hostname to ${hostAlias}"
